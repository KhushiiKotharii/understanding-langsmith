...
#problem with previous version->every single time pdf was getting laoded then embeddings were getting generated,this code solves this latency issue by storing the embedding(by creating the index)
import os
import json
import hashlib
